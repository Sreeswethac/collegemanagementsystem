...
//                    l1.setOnItemClickListener((AdapterView.OnItemClickListener) Parent_home.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.mark) {
            ...
            Intent i=new Intent(getApplicationContext(),Parent_vew_mark.class);
            startActivity(i);
        ...
        if (id == R.id.attendance) {
            ...
            Intent i=new Intent(getApplicationContext(),Parent_view_attendance.class);
            startActivity(i);
        ...
        else if (id == R.id.postpcm) {

            Intent i=new Intent(getApplicationContext(),Parent_send_complaint.class);
            startActivity(i);


        }
        else if (id == R.id.viewsol) {

            Intent i=new Intent(getApplicationContext(),Parent_vew_complant_reply.class);
            startActivity(i);
