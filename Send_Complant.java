...
public class Send_Complant extends AppCompatActivity {
    EditText e1;
    Button b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send__complant);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(!complaint.matches("^[a-zA-Z ]*$"))
                {
                    ...
                    RequestQueue queue = Volley.newRequestQueue(Send_Complant.this);
                    String url1 = "http://" + sh.getString("ip", "") + ":5000/student_send_complaint";
